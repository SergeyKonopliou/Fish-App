...
public class Helper {
	...
	public static CatalogFish<?> createCatalogFish() {
		...
		String[] states = new String[] { "жор", "клев", "клев", "жор", "клев", "нет клева", "нет клева", "нет клева",
				"клев", "жор", "жор", "жор", };
		...
		String[] states1 = new String[] { "клева нет", "клева нет", "клева нет", "слабый клев", "клев", "жор", "жор",
				"жор", "клев", "слабый клев", "клева нет", "клева нет", };
		...
		String[] states2 = new String[] { "слабый клев", "клев", "жор", "жор", "жор", "клев", "клев", "клев", "клев",
				"жор", "жор", "слабый клев", };
		...
		perch.setDescription(
				"Внешний вид. Тело, сжатое с боков, покрыто мелкой ктеноидной чешуей, щеки целиком в чешуе. Форма тела подлежит значительным\n"
						...
						+ "собственных размеров.");
		String[] states3 = new String[] { "клев", "клев", "клев", "клев", "клев", "клев", "клев", "клев", "клев",
				"клев", "клев", "клев", };
		...
		String[] states4 = new String[] { "клева нет", "клева нет", "клева нет", "слабый клев", "клев", "жор", "жор",
				"жор", "клев", "слабый клев", "клева нет", "клева нет", };
	...
	public static StringBuilder findDate(List<Region> regions, int day, int month) {
		...
		for (Region region : regions) {
			...
			if (countBan == 0) {
				str.append("Запретов нет").append("\n");
			}
			str.append("--------------------------------------------------------------------").append("\n");
		}
		return str;
